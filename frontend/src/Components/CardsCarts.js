...
function CardsCarts(){
  ...
  <div className="border-r border-b border-l border-black lg:border-l-0 lg:border-t lg:border-black bg-white rounded-b lg:rounded-b-none lg:rounded-r p-2 flex flex-col justify-between leading-normal " style={{height:'24.5vh'}}>
    <div className="mb-1 ">
